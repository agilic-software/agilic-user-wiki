...
![08a-001](media/08a-001.png ':size=624')
...
![08a-002](media/08a-002.png ':size=510')
...
![08a-003](media/08a-003.png ':size=624')
...
![08a-004](media/08a-004.png ':size=624')
...
![08a-005](media/08a-005.png ':size=511')

See also: Everything captured on an item's full detail view is covered in [Working Standard Items (Section 6)](/s6-work-item-types-and-details/working-standard-items.md) and [Working RIDE Items (Section 6)](/s6-work-item-types-and-details/working-ride-items.md).
...
![08a-006](media/08a-006.png ':size=624')
