...
![03g-004](media/03g-004.png)

# Related Tasks

-   To manage the Work Package's day-to-day work, see [Work Item Types (Section 6)](https://agilic-wiki.local/s6-work-item-types)

-   To track risks, issues, dependencies, and escalations, see [Working RIDE Items (Section 6)](https://agilic-wiki.local/s6-working-ride-items)

-   For defining scope, preparing your roster, and setting allocations before this stage, see [Work Package Planning (Section 3)](https://agilic-wiki.local/s3-work-package-planning)

-   For details on what different access levels mean, see [Permissions for People (Section 2)](https://agilic-wiki.local/s2-permissions-for-people)
