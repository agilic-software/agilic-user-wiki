...
3)](#/s3-work-packages/navigate-a-work-package).
For creating a WP and managing its roster, see [Create a Work Package
(Section
3)](#/s3-work-packages/create-a-work-package) and
...
![03a-006](media/03a-006.png)

***See also:** Full deep-dive coverage in [Work Package Settings
(Section
3)](#/s3-work-packages/work-package-settings).*
