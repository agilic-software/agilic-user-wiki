...
*See also: Each of these tabs is also reachable directly from the persistent top toolbar's quick-access pills --- see [How to Navigate as a User (Section 1)](https://agilic-wiki.local/s1-navigate-as-a-user).*
