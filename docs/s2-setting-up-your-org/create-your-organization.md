...
Sign In\
![02a-006](media/02a-006.png)

![02a-007](media/02a-007.png)
...
-   [Configure your Org Settings (Section 2)](https://agilic-wiki.local/s2-org-settings) --- set date/time preferences, labels, and templates before your team starts creating Work Packages
...
(Section
2)](https://agilic-wiki.local/s2-adding-and-managing-people).
For org-wide configuration, see [Setting Up Your Organization's
Settings (Section
2](https://agilic-wiki.local/s2-org-settings)). For
