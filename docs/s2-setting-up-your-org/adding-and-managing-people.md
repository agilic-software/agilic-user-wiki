...
See also: For a full breakdown of every access layer, see [Permissions for People (Section 2)](/s2-setting-up-your-org/permissions-for-people.md).
...
Only one person can have Billing rights.

See also: For the full Billing Admin rules, see [Permissions for People (Section 2)](/s2-setting-up-your-org/permissions-for-people.md).
