...
> **See also:** For where each of the five boards lives and how they differ in scope, see Kanban (Section 15).
...
![Reporting sub-tabs including Kanban](media/13-001.png)
...
![Pick Saved Kanban View](media/13-002.png)

## Adding Columns

Select Add Columns to choose what your board is organized by. You can select multiple fields at once; each of the choices below has options of what field(s) you want to add to the board. Each field selected will become its own column:
...
![Add Columns modal](media/13-003.png)

> **Tip:** Use the search box at the top of the Add Columns modal if you're looking for a specific field rather than scrolling the full list.

## Reordering Columns

Select Reorder Columns to drag columns into the order you want.

![Reorder Columns](media/13-004.png)
...
![Kanban card detail](media/13-005.png)

> **See also:** Everything captured on an item's full detail view is covered in [Working Standard Items](/section-4-core-day-to-day-work/working-standard-items.md) and [Working RIDE Items](/section-4-core-day-to-day-work/working-ride-items.md) (Section 4).
...
![Comment Box from a card](media/13-006.png)
...
> **Note:** Unlike the Comment Triskele elsewhere in Agilic (e.g. on an item's row in list view — see [Working Standard Items](/section-4-core-day-to-day-work/working-standard-items.md), Section 4), the Kanban card version does not include an Add RIDE option — only Comment and New Status.
...
![Board options menu](media/13-007.png)

## Working with Templates

Show Template List displays every board template you've saved, each with edit and delete actions.

![Template List](media/13-008.png)

> **Tip:** Templates are a good way to standardize how your team looks at work — e.g. a "Dev - Priority - Grab an Item" board everyone on the team uses the same way.
...
- Fields that can only have one choice (Bound Labels, Phases, Item States, Responsible, etc.) will remove the old data and replace it with the new.
...
> **Not yet available:** Secure Work Packages and Secure Items are planned but not yet implemented in Agilic — this could be several months out. This section describes the intended behavior once built, not current functionality.
...
> **See also:** Full detail in [Permissions for People](/section-2-setting-up-your-org/permissions-for-people.md) (Section 2).
